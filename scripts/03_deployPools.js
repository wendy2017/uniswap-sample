...
console.log("network provider==", ethers.provider, provider);
...
async function deployPool(token0, token1, fee, price) {
  ...
  console.log("deployPool==", owner, token0, token1, fee, price);
  ...
  console.log("deployPool==transaction:", transaction?.hash);
